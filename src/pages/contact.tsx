...
const Contact = () => {
  ...
  const [refForm, isVisibleForm] = useOnScreen({ threshold: 0.1 }) as [React.RefObject<HTMLElement>, boolean];
  const [refHours, isVisibleHours] = useOnScreen({ threshold: 0.5 }) as [React.RefObject<HTMLElement>, boolean];
    ...
    <>
      ...
      <section className="section-padding bg-foreground">
        <div className="studio-container text-primary-foreground flex flex-col justify-start gap-5 py-12">
          ...
          <p className="text-body text-lit-primary-foreground max-w-xl fade-up fade-in" style={{ animationDelay: '0.4s' }}>
      ...
      <section ref={refForm} className="section-padding">
        <div className="studio-container flex flex-col md:flex-row gap-16 lg:gap-24">
          <div onSubmit={handleSubmit} className={`space-y-6 w-full fade-right ${isVisibleForm ? "fade-in" : ""}`}>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-ui uppercase tracking-wide" htmlFor="email">
                Email:
              </label>
              <input
                className="bg-foreground text-primary-foreground py-2 px-4 focus:outline-none focus:ring-2 focus:ring-muted-foreground transition-all duration-300"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-ui uppercase tracking-wide" htmlFor="subject">
                Subject:
              </label>
              <select
                id="subject"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-ui uppercase tracking-wide" htmlFor="message">
                Message:
              </label>
              <textarea
          ...
          <div className={`w-full fade-left ${isVisibleForm ? "fade-in" : ""}`} style={{ transitionDelay: '0.2s' }}>
            ...
            <div className="text-muted-foreground-d">
              <div className="space-y-2 mb-6 hover:translate-x-2 transition-transform duration-300">
                ...
                <Link to={"mailto:hello@bloomstudio.com"} className="hover:text-foreground transition-colors duration-300">
              ...
              <div className="space-y-2 mb-6 hover:translate-x-2 transition-transform duration-300">
                ...
                <Link to={"https://instagram.com"} target="_blank" className="hover:text-foreground transition-colors duration-300">
                  @Instabloomstudio
                </Link>
              </div>
              <div className="space-y-2 mb-6 hover:translate-x-2 transition-transform duration-300">
                ...
                <Link to={"https://tiktok.com"} target="_blank" className="hover:text-foreground transition-colors duration-300">
                  @TikTokbloomstudio
                </Link>
              </div>
              <div className="space-y-2 mb-6 hover:translate-x-2 transition-transform duration-300">
      ...
      <section ref={refHours} className="section-padding bg-foreground">
        <div className="studio-container space-y-6">
          <h3 className={`text-center text-title uppercase text-primary-foreground fade-down ${isVisibleHours ? "fade-in" : ""}`}>
            Studio hours
          </h3>
          <div className={`text-primary-foreground flex justify-evenly mb-10 fade-up ${isVisibleHours ? "fade-in" : ""}`} style={{ transitionDelay: '0.2s' }}>
          ...
          <p className={`text-center text-ui uppercase tracking-wide text-lit-primary-foreground fade-up ${isVisibleHours ? "fade-in" : ""}`} style={{ transitionDelay: '0.4s' }}>
