...
const OnlineStudio = () => {
  ...
  return (
    <>
      {/** Hero Section **/}
      <section ref={refEvent} className="section-padding bg-foreground min-h-screen flex items-center justify-center">
        <div className="studio-container text-primary-foreground flex flex-col items-center justify-center gap-8 text-center">
          ...
          <div className={`space-y-6 max-w-3xl fade-up ${isVisibleEvent ? "fade-in" : ""}`}>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center mt-8">
            <div className={`text-center fade-up ${isVisibleEvent ? "fade-in" : ""}`} style={{ transitionDelay: '0.4s' }}>
          ...
          <div className="max-w-2xl mx-auto text-center space-y-8">
            ...
            <div className="border-t-2 border-border pt-8 space-y-4">
              <div className="flex flex-col md:flex-row justify-center gap-8">
                <div className={`text-center" fade-right ${isVisibleHoursInfos ? "fade-in" : ""}`} style={{ transitionDelay: '0.2s' }}>
                  <p className="text-ui uppercase tracking-wide text-muted-foreground mb-2">
                    Email
                  </p>
                ...
                <div className={`text-center" fade-left ${isVisibleHoursInfos ? "fade-in" : ""}`} style={{ transitionDelay: '0.2s' }}>
                  <p className="text-ui uppercase tracking-wide text-muted-foreground mb-2">
                    Téléphone
                  </p>
                  <p className="text-body text-foreground">+33 1 23 45 67 89</p>
                </div>
              </div>
            </div>
          </div>
